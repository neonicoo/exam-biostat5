...
Maintenant essayons de regarder s'il existe un effet globale des continents. Pour cela nous allons construire un modèle qui comptabilisera la variabilité expliquée par l'effet région avec l'erreur pure dans la résiduelle.
